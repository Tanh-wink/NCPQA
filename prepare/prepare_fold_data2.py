...
class Data_processor(object):
    ...
    def _convert_examples_to_features(self, examples, doc_stride, is_train=True, topRate=0.1):
    ...
    def prepare_pred_dataloader(self, predict_file, pred_features_file, predict_batch_size, doc_stride):
