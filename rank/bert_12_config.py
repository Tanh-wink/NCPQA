...
def getArgs():
    ...
    parser.add_argument("--train_file", default='../data/rank/train_data_top5.pkl', type=str,
                        help="SQuAD json for training. E.g., train-v1.1.json")
    ...
    parser.add_argument(
        "--predict_model_path",
        default="/home/th/PycharmProjects/python3.5/NCPQA/output_model/bert_base_addBad/2020-03-23@00_26_53",
        type=str,
        help="the model dir for prediction",
    )
